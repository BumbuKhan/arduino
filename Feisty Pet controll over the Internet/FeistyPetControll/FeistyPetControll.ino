...
#define servoPin D0
const char* ssid = "RaQuSoTu";
const char* password = "bumbu2016";
...
void loop() {
  ...
  // Match the request
  int val;
  if (req.indexOf("/face/pretty") != -1){
  myservo.write(100); // the less this value the angriest it is 
  } else if (req.indexOf("/face/angry") != -1) {
